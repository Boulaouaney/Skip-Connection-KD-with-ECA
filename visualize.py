...
parser = argparse.ArgumentParser(
    description="Visualise the architecture of a pretrained pytorch model using torchviz."
)
parser.add_argument(
    "--pair_keys",
    type=int,
...
parser.add_argument(
    "--ECA_block", type=str, default="parallel", help="---ECA block in parallel or last"
)
...
make_dot(torch_out, params=dict(torch_model.named_parameters())).render(
    f"cnn_torchviz_{args.model}_{args.pair_keys}", format="png"
)
