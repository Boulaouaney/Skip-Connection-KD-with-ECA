...
parser = argparse.ArgumentParser(
    description="Plot teacher and student models accuracy and loss graph"
)
parser.add_argument(
    "--plot_type", type=str, required=True, help="---Plot type: accuracy or loss"
)
